...
$.fn.overhang = function (arguments) {
  ...
  var $inputField = attributes.multiline ? $("<textarea style='width:"+ attributes.textWidth +";height:"+ attributes.textHeight +"' class='overhang-prompt-field'></textarea>") : $("<input class='overhang-prompt-field' />");
